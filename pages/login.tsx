                        ...
                        >
                            ...
                            >
                                {(loading === false) ? (
                                        ...
                                        {(isSignedIn === false) ? (
                                                ...
                                                >
                                                    ...
                                                    <Box sx={{ display: "flex", alignItems: "center" }}>
                                                        <Box
                                                            ...
                                                            src={"/Images/Login/arrow_right.png"}
                                                            title={"next"}
                                                            alt="next"
                                                        />
                                                    </Box>
                                            ...
                                            <Box>
                                                ...
                                                <Typography sx={{
                                                    ...
                                                    Your account was created at : {signedInUserData.metadata.creationTime}.
                                                </Typography>
                                                <Typography sx={{
                                                    fontStyle: "normal",
                                                    fontWeight: "400",
                                                    ...
                                                    Last Time you Signed In : {signedInUserData.metadata.lastSignInTime}.
                                                </Typography>
                                                ...
                                                <Box
                                                    ...
                                                    <Button
                                                        variant="outlined"
                                                        color="error"
                                                        sx={{ borderRadius: "12px", textTransform: "none", fontSize: { sm: "18px", xs: "20px" } }}
                                                        onClick={() => {
                                                            signOut(auth).then(() => {
                                                                // Sign-out successful.
                                    ...
                                    <Box sx={{ display: 'flex', flexDirection: "column", justifyContent: "center", alignItems: "center", mt: '30px' }}>
                                        <Typography
                                            sx={{
                                                color: "#0062FF",
                                                fontStyle: "normal",
